...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="CAN_NODE" URI="http://resources/4.1.24/app/CAN_NODE/0" description="The CAN_NODE APP configures a node and MO registers &#xA;of MultiCAN module. &#xA;It provides run-time functions to change the node baud rate &#xA;and to enable/disable node and MO events." mode="NOTSHARABLE" version="4.1.24" minDaveVersion="4.0.0" instanceLabel="CAN_NODE_0" appLabel="">
  ...
  <virtualSignals name="event_lmo_03_rxinp" URI="http://resources/4.1.24/app/CAN_NODE/0/vs_message3_rxinp" hwSignal="rxinp" hwResource="//@hwResources.5" visible="true"/>
  ...
  <hwResources name="CAN Receive Pin" URI="http://resources/4.1.24/app/CAN_NODE/0/__pin_hwres_port_pad_can_rx" resourceGroupUri="devicepackage/0/5" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/DEVICEPACKAGE/DEVICEPACKAGE_0.dd#//@provided.14"/>
  </hwResources>
  <hwResources name="CAN Transmit Pin" URI="http://resources/4.1.24/app/CAN_NODE/0/__pin_hwres_port_pad_can_tx" resourceGroupUri="devicepackage/0/6" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
  ...
  <connections URI="http://resources/4.1.24/app/CAN_NODE/0/http://resources/4.1.24/app/CAN_NODE/0/vs_message1_rxinp/http://resources/4.0.10/app/INTERRUPT/1/vs_nvic_signal_in" sourceSignal="event_lmo_01_rxinp" targetSignal="sr_irq" srcVirtualSignal="//@virtualSignals.9">
  ...
  <connections URI="http://resources/4.1.24/app/CAN_NODE/0/http://resources/4.1.24/app/CAN_NODE/0/vs_message2_rxinp/http://resources/4.0.10/app/INTERRUPT/2/vs_nvic_signal_in" sourceSignal="event_lmo_02_rxinp" targetSignal="sr_irq" srcVirtualSignal="//@virtualSignals.11">
  ...
  <connections URI="http://resources/4.1.24/app/CAN_NODE/0/http://resources/4.1.24/app/CAN_NODE/0/vs_message3_rxinp/http://resources/4.0.10/app/INTERRUPT/3/vs_nvic_signal_in" sourceSignal="event_lmo_03_rxinp" targetSignal="sr_irq" srcVirtualSignal="//@virtualSignals.13">
